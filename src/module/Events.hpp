...
namespace SE_Events
{
	...
	struct Event_Base
	{
		Event_Base( SE_Module_ID nType, ushort nCode );
...
//		SE_Array< SE_Module_ID > Modules_For; // if 0, global
	...
	{
		Event_Var( SE_Module_ID nType, u_short ID, T Arg ) : Event_Base( nType, ID )
		{
			this->Argument = Arg;
		}
	...
	{
		Event_Var2( SE_Module_ID nType, u_short ID, T1 Arg1, T2 Arg2 ) : Event_Base( nType, ID )
		{
			this->Argument1 = Arg1;
			this->Argument2 = Arg2;
		}
	...
	struct Event_Manager: public Event_Manager_Base
	{
		...
		bool Handle_Event( Event_Base* Event );
