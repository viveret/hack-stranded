...
void main()
{
	...
	gl_FragColor=vec4(ambientColor*outColor+diffuseContribution *diffuseColor*outColor+ specularContribution*specularColor,1.0 + outUV.x * 0.001) * gl_Color;// to stop optimization
}
